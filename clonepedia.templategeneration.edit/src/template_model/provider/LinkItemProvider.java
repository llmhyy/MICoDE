...
/**
 * This is the item provider adapter for a {@link template_model.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addVariationTypePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Template_modelPackage.Literals.LINK__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIsCompletePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_isComplete_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_isComplete_feature", "_UI_Link_type"),
				 Template_modelPackage.Literals.LINK__IS_COMPLETE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Variation Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addVariationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_variationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_variationType_feature", "_UI_Link_type"),
				 Template_modelPackage.Literals.LINK__VARIATION_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
