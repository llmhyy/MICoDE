...
/**
 * This is the item provider adapter for a {@link template_model.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_ownerType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_ownerType_feature", "_UI_Field_type"),
				 Template_modelPackage.Literals.FIELD__OWNER_TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Template_modelPackage.Literals.FIELD__TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Field.class)) {
			case Template_modelPackage.FIELD__TYPE:
