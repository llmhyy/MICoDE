...
/**
 * This is the item provider adapter for a {@link template_model.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Template_modelPackage.Literals.TYPE__METHODS);
			childrenFeatures.add(Template_modelPackage.Literals.TYPE__FIELDS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Type.class)) {
			case Template_modelPackage.TYPE__METHODS:
			case Template_modelPackage.TYPE__FIELDS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Template_modelPackage.Literals.TYPE__METHODS,
				 Template_modelFactory.eINSTANCE.createMethod()));

		newChildDescriptors.add
			(createChildParameter
				(Template_modelPackage.Literals.TYPE__FIELDS,
