...
/**
 * This is the item provider adapter for a {@link template_model.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Template_modelPackage.Literals.CLASS__SUPER_CLASS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addInterfacesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_interfaces_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_interfaces_feature", "_UI_Class_type"),
				 Template_modelPackage.Literals.CLASS__INTERFACES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Template_modelPackage.Literals.CLASS__INNER_CLASSES);
		}
	...
	public String getText(Object object) {
		String label = ((template_model.Class)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(template_model.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Template_modelPackage.Literals.CLASS__INNER_CLASSES,
