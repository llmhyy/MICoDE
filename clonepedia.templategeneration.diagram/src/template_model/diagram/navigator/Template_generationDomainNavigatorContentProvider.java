 ...
 * @generated
 */
public class Template_generationDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public Template_generationDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof template_model.diagram.navigator.Template_generationDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((template_model.diagram.navigator.Template_generationDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new template_model.diagram.navigator.Template_generationDomainNavigatorItem(
