 ...
 * @generated
 */
public class Method3ItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public Method3ItemSemanticEditPolicy() {
		super(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (template_model.diagram.providers.Template_generationElementTypes.Call_4007 == req
				.getElementType()) {
			return getGEFWrapper(new template_model.diagram.edit.commands.CallCreateCommand(
	...
	protected Command getReorientRelationshipCommand(
		...
		case template_model.diagram.edit.parts.CallEditPart.VISUAL_ID:
			return getGEFWrapper(new template_model.diagram.edit.commands.CallReorientCommand(
					req));
		}
