 ...
 * @generated
 */
public class Class2ItemSemanticEditPolicy
		extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (template_model.diagram.part.Template_generationVisualIDRegistry
					.getVisualID(incomingLink) == template_model.diagram.edit.parts.ExtendClassEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (template_model.diagram.part.Template_generationVisualIDRegistry
					.getVisualID(outgoingLink) == template_model.diagram.edit.parts.ImplementEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
			...
			if (template_model.diagram.part.Template_generationVisualIDRegistry
					.getVisualID(outgoingLink) == template_model.diagram.edit.parts.ExtendClassEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (template_model.diagram.providers.Template_generationElementTypes.ExtendClass_4010 == req
				.getElementType()) {
			return getGEFWrapper(new template_model.diagram.edit.commands.ExtendClassCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientRelationshipCommand(
		...
		case template_model.diagram.edit.parts.ExtendClassEditPart.VISUAL_ID:
			return getGEFWrapper(new template_model.diagram.edit.commands.ExtendClassReorientCommand(
					req));
		}
