 ...
 * @generated
 */
public class ImplementCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ImplementCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return template_model.diagram.edit.policies.Template_generationBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateImplement_4008(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		template_model.Implement newElement = template_model.Template_modelFactory.eINSTANCE
				.createImplement();
		getContainer().getLinks().add(newElement);
		newElement.setClass(getSource());
		newElement.getInterface().add(getTarget());
		doConfigure(newElement, monitor, info);
		((CreateElementRequest) getRequest()).setNewElement(newElement);

		Class clazz = (Class) getSource();
		Interface interf = (Interface) getTarget();

		clazz.getInterfaces().add(interf);
	 ...
	 * @generated
	 */
	protected void doConfigure(template_model.Implement newElement,
