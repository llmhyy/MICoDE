 ...
 * @generated
 */
public class Method4EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new template_model.diagram.edit.policies.Method4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof template_model.diagram.edit.parts.MethodName4EditPart) {
			((template_model.diagram.edit.parts.MethodName4EditPart) childEditPart)
