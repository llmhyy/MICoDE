 ...
 * @generated
 */
public class MethodDescription2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MethodDescription2EditPart(View view) {
		super(view);
	}
			...
			parser = template_model.diagram.providers.Template_generationParserProvider
					.getParser(
							...
							template_model.diagram.part.Template_generationVisualIDRegistry
									.getType(template_model.diagram.edit.parts.MethodDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
