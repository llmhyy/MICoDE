...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new template_model.diagram.edit.policies.ClassItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof template_model.diagram.edit.parts.ClassNameEditPart) {
			((template_model.diagram.edit.parts.ClassNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureClassNameFigure());
			return true;
		}
		if (childEditPart instanceof template_model.diagram.edit.parts.ClassFullNameEditPart) {
			((template_model.diagram.edit.parts.ClassFullNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureClassFullNameFigure());
			return true;
		}
		if (childEditPart instanceof template_model.diagram.edit.parts.ClassClassDeclaredMethodComparmentEditPart) {
			...
			pane.add(
					((template_model.diagram.edit.parts.ClassClassDeclaredMethodComparmentEditPart) childEditPart)
							.getFigure(), gridData);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof template_model.diagram.edit.parts.ClassClassDeclaredMethodComparmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureClassDeclaredMethodCompartment();
			pane.remove(((template_model.diagram.edit.parts.ClassClassDeclaredMethodComparmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public class ClassFigure extends RectangleFigure {
		...
		public void paintFigure(Graphics graphics) {
			...
			if(classModel.getDescription().equals("-1")){
				setBackgroundColor(LIB_BACK);
			}
			else{
	...
	static final Color LIB_BACK = new Color(null, 255, 166, 106);
	/**
	 * @generated
	 */
