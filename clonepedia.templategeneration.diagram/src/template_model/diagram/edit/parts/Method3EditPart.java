 ...
 * @generated
 */
public class Method3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new template_model.diagram.edit.policies.Method3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof template_model.diagram.edit.parts.MethodName3EditPart) {
			((template_model.diagram.edit.parts.MethodName3EditPart) childEditPart)
