...
public class MethodEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new template_model.diagram.edit.policies.MethodItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof template_model.diagram.edit.parts.MethodNameEditPart) {
			((template_model.diagram.edit.parts.MethodNameEditPart) childEditPart)
