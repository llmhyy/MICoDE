 ...
 * @generated
 */
public class MethodName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new template_model.diagram.edit.policies.Template_generationTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new template_model.diagram.edit.parts.TemplateGraphEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		/*if (parser == null) {
			parser = template_model.diagram.providers.Template_generationParserProvider
					.getParser(
							template_model.diagram.providers.Template_generationElementTypes.Method_3001,
							getParserElement(),
							template_model.diagram.part.Template_generationVisualIDRegistry
									.getType(template_model.diagram.edit.parts.MethodName2EditPart.VISUAL_ID));
		}
		return parser;*/
		return null;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					template_model.diagram.edit.parts.Template_generationEditPartFactory
