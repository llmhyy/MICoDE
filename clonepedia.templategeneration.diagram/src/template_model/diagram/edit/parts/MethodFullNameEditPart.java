 ...
 * @generated
 */
public class MethodFullNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MethodFullNameEditPart(View view) {
		super(view);
	}
			...
			parser = template_model.diagram.providers.Template_generationParserProvider
					.getParser(
							...
							template_model.diagram.part.Template_generationVisualIDRegistry
									.getType(template_model.diagram.edit.parts.MethodFullNameEditPart.VISUAL_ID));
		}
		return parser;
	}
