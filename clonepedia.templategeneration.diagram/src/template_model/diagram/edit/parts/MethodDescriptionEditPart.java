 ...
 * @generated
 */
public class MethodDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MethodDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = template_model.diagram.providers.Template_generationParserProvider
					.getParser(
							...
							template_model.diagram.part.Template_generationVisualIDRegistry
									.getType(template_model.diagram.edit.parts.MethodDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
