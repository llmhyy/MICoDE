...
public class Field2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new template_model.diagram.edit.policies.Field2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof template_model.diagram.edit.parts.FieldName2EditPart) {
			((template_model.diagram.edit.parts.FieldName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFieldNameFigure());
			return true;
		}
		return false;
	}
	...
	public class FieldFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureFieldNameFigure;
		...
		private void createContents() {
			...
			fFigureFieldNameFigure = new WrappingLabel();

			fFigureFieldNameFigure.setText("<...>");

			fFigureFieldNameFigure.setBorder(new MarginBorder(getMapMode()
		...
		public void paintFigure(Graphics graphics) {
			...
			Field fieldModel = (Field) resolveSemanticElement();
			if (fieldModel.isIsComplete()) {
				setBackgroundColor(THIS_BACK);
				setLineStyle(SWT.LINE_SOLID);
			} else {
				setBackgroundColor(UNCOMPLETE_FORE);
				if(fieldModel.getVariationType() != null){
					if(fieldModel.getVariationType().equals("optional")){
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureFieldNameFigure() {
			return fFigureFieldNameFigure;
		}

	}

	static final Color UNCOMPLETE_FORE = new Color(null, 200, 199, 139);
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 240, 245, 137);
